...
if(isset($_POST["submit"]))
{
    ...
    } elseif(filter_var($contact_email, FILTER_VALIDATE_EMAIL) == false)  {
	...
	//Subject Validation
		...
		$result = 'Error : Please select the contact purpose.';
    }
	...
	else
	{
		...
		{	
			...
			$email_msg = "<div><p>Hello,</p><p>You have received a new query from your website, following are the details : </p><p>Name : $contact_name</p><p>Email : $contact_email</p><p>Subject : $contact_subject</p><p>Purpose : $contact_purpose</p><p>Message : $contact_message</p></div>";
